...
images = glob.glob('C:/Users/Owen/Desktop/School/ECE_2020_2021/Term 1/ELEC 421/Project/Code/videos/phone_camera_calibration/*.JPG')

if __name__ == '__main__':

    checkerBoard = (6,8) #6 x 8 checkerboard for camera calibration
    ...
    mapX, mapY = cv2.initUndistortRectifyMap(camera_matrix, distortion_coeff, np.eye(3),camera_matrix, gray_img.shape[::-1], cv2.CV_32FC1)
